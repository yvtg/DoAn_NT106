...
namespace Program
{
    public partial class Form_OTP : Form
    {
        ...
        public Form_OTP(string email, string otp)
        {
            InitializeComponent();
            this.email = email;
            ...
            client.OTPVerified += OnOTPVerified;
            client.OTPFailed += OnOTPFailed;
        ...
        private void OnOTPVerified()
        {
            ...
            {
                this.Invoke(new Action(OnOTPVerified));
                return;
            }
        ...
        private void OnOTPFailed()
        {
            if (this.InvokeRequired)
            {
                this.Invoke(new Action(OnOTPFailed));
                return;
            }
